...
function ecommerce_star_general_admin_notice(){
         ...
         $msg = sprintf('<div data-dismissible="disable-done-notice-forever" class="notice notice-info" >
		 		<h3>%1$s</h3><p>
				<a href=%2$s style="text-decoration: none;" class="button button-primary"> %3$s </a>&nbsp;<a href=%4$s style="text-decoration: none;" target="_blank" class="button button-primary"> %5$s </a>
				<span>%6$s</span>
				<a href="?ecommerce_star_notice_dismissed" target="_self"  style="text-decoration: none; float: right;" >%7$s</a></p></div>',
...
if ( isset( $_GET['ecommerce_star_notice_dismissed'] ) ){
	...
	update_option('ecommerce_star_notification', 'disposed');
}
...
if (($ecommerce_star_notification !='disposed' || $ecommerce_star_notification == '') && !$ecommerce_star_refreshed ){
